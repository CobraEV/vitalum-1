...
export function Hero() {
  return (
    <section className="relative isolate">
        ...
        <div className="grid items-center gap-10 py-10 lg:grid-cols-2 lg:py-16">
          ...
          >
            <h1 className="text-3xl font-bold tracking-tight text-primary sm:text-4xl lg:text-5xl">
              Vertrau­te Pflege, verbunden mit <span className='text-secondary'>Zuhause</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <Button asChild className="transition-transform hover:translate-y-[-1px]">
                <Link href="/termin">Termin buchen</Link>
              </Button>
              <Button variant="outline" asChild className="transition-transform hover:translate-y-[-1px]">
          ...
          <motion.div
            className="relative aspect-[16/10] w-full overflow-hidden rounded-xl border border-border shadow-sm lg:aspect-[4/3]"
      ...
      {/* Subtle background tint at bottom to blend */}
